...
/>
      ...
      <div className="py-4 px-4 bg-white">
        <h3 className="text-md font-semibold text-gray-600">{item?.name}</h3>
        <p className="mt-4 text-lg font-thin description">{item?.description.substring(0,80)}...</p>
        <h3 className="text-md font-semibold text-gray-600">Food Pairings</h3>
        {
